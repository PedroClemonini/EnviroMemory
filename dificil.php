...
if (!isset($_SESSION['memory_game'])) {
    ...
    $array_itens = ['im01', 'im02','im03','im04','im05','im06','im07','im08','im09', 'im10', 'im11', 'im12', 'im13', 'im14', 'im15', 'im16', 'im17', 'im18'];
    ...
    $_SESSION['memory_game'] = [
        'cards' => $cards,
        'flipped' => array_fill(0, 36, false), // Inicialmente, nenhuma carta está virada
...
<head>
    ...
    <title>Enviro Memory - Dificil</title>
