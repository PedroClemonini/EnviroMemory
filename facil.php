...
if (!isset($_SESSION['memory_game'])) {
    ...
    $array_itens = ['im01', 'im02','im03','im04','im05','im06','im07','im08'];
    ...
    $_SESSION['memory_game'] = [
        'cards' => $cards,
        'flipped' => array_fill(0, 16, false), // Inicialmente, nenhuma carta está virada
...
<head>
    ...
    <title>Enviro Memory - Fácil</title>
